...
const GradientWaves = ({
  ...
  useEffect(() => {
    ...
    const horizonUniform = u.uHorizonColor.value;
    const waveUniform = u.uWaveColor.value;
    const crestUniform = u.uCrestColor.value;

    horizonUniform[0] = horizon[0];
    horizonUniform[1] = horizon[1];
    horizonUniform[2] = horizon[2];
    waveUniform[0] = wave[0];
    waveUniform[1] = wave[1];
    waveUniform[2] = wave[2];
    crestUniform[0] = crest[0];
    crestUniform[1] = crest[1];
    crestUniform[2] = crest[2];
  }, [
    horizonColor,
    waveColor,
    crestColor,
